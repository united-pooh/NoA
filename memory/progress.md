...
- [x] NoA trajectory-control M5：接入 runner lifecycle events 与确定性下一步闸门，加入 JoyAI 前置解除回主线 fixture <!-- todo:trajectory-m5 -->
- [x] NoA trajectory-control M6：旧 Skill 语义迁移、MCP runtime authority 产品入口与 sdist/wheel allowlist 更新 <!-- todo:trajectory-m6 -->
- [x] NoA trajectory-control M7：JoyAI/SCNet 完整验收、打包复核与发布驻点（功能门全绿；uv build 仍受 PyPI 网络限制） <!-- todo:trajectory-m7 -->
